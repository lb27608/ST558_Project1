...
pums_years <- function(yr_list) {
  ...
  for(i in 1:yr_len){
    ...
    yr_tib <- get_PUMS_API(yr=yr_i,vello) |> mutate(year=yr_i)
...
Suppose we want to know about how the distribution of age across school enrollment in the Northeast region in the years 2017, 2018, and 2019.
